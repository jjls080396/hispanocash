            ...
            <div class="col-12 px-0 px-sm-1">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 py-3 text-center">
                                    <span class="hc--description">
                                         <span class="poppins-bold">Bienvenido</span>
                                    </span>
                                </div>
                            </div>
                        </div>

                        <div class="col-12 col-md-6 mb-4 px-0 px-sm-1" style="display:none;">
                            <div class="row">
                        ...
                        <div class="col-12 col-md-12 px-0 px-sm-1">
                            ...
                            <div class="row h-100 w-100 border border-success hc--rounded py-3 mb-2">
                                ...
                                <div class="col-6 text-right pl-4 pr-4 pb-4">
                                    <span class="hc--description-sm poppins-semibold">
                                        Número de referencia:
                                    </span>
                                </div>
                                <div class="col-6 text-left pl-4 pr-4">
                            ...
                            <div class="col-12 d-flex justify-content-end all_transition_slow py-3" >
	...
	export default {
        ...
        redirect(name_route) {
                ...
                .then(async response => {
                    ...
                    if(response === undefined) {
                        ...
                        if(response['detail'] == "Unauthorized") {
                            ...
                            console.log('llamda validateReference Qr.vue')
                            this.logout()
                        }
                    }
            ...
            async paymentReference() {
               ...
               let login = {
                            data: {
                                    "full_name": "Pagos desde QR"
                                    }
                            }
                 await _Store.dispatch('createSession', login)
                //console.log(Number(this.amount) * 100)

                let body = {
                    name: `Abono a contrato ${this.contract}`
                }
                fetch(`${CONFIG.server[CONFIG.env].api}/payments/stripe/create-payment-without-login?currency=${this.currency}&amount=${Number(this.amount) * 100}&reference=${this.reference}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                .catch(error => console.error('Error:', error))
                .then(async response => {
                    console.log('Success: /payments/stripe/create-payment-without-login ', response)
                    ...
                    if(response['url_to_payment'] !== undefined) {
                        ...
                        if(response['detail'] == "Unauthorized") {
                            ...
                            console.log('llamda logout paymentReference Qr.vue')
                            this.logout()
                        }
                    }
            ...
            async checkStatusPayment() {
                ...
                fetch(`${CONFIG.server[CONFIG.env].api}/payments/stripe/capture-order-without-login?authorization_id=${session.authorization_id}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    }
                ...
                .then(async response => {
                    ...
                    if(response['payment_status'] !== undefined) {
                        ...
                        console.log('llamda logout checkStatusPayment Qr.vue')
                            
                        }else if(response['detail'] == "Orden unpaid."){
                            this.modal_state = 'error'
                            this.show_modal = true
                        }
                    }
        ...
        async created() {
            ...
            console.log('called QrSA.vue')
            this.reference = this.$route.query.transaction_reference
            this.contract = this.$route.query.contract_number
            this.client = this.$route.query.payer_name

            if(this.$route.params.make_payment) {
                console.log('from external stripe')
            ...
            //                 variant: 'danger'
            //             })
            //             console.log('llamda logout created Qr.vue')
            //             this.logout()
            //         }
            //     }
